...
class LegacyAppGatewayTest extends AbstractGatewayTestCase
{
    ...
    public function testCompletePurchase()
    {
        ...
        $data = [
            'memo'         => '',
            'result'       => '_input_charset="UTF-8"&alipay_sdk="frainzy1477/alipay"&notify_url="https://www.example.com/notify"&out_trade_no="2016092309184123456"&partner="80123456789"&payment_type="1"&seller_id="80123456789"&service="mobile.securitypay.pay"&subject="test"&total_fee="0.01"&success="true"',
            'resultStatus' => '9000'
        ];
